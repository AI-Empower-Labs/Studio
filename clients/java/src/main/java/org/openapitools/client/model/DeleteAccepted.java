...
public class DeleteAccepted {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteAccepted deleteAccepted = (DeleteAccepted) o;
    return Objects.equals(this.index, deleteAccepted.index) &&
        Objects.equals(this.documentId, deleteAccepted.documentId) &&
        Objects.equals(this.message, deleteAccepted.message);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccepted.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccepted is not found in the empty JSON string", DeleteAccepted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccepted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccepted` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccepted.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccepted' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccepted> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccepted.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccepted>() {
           @Override
           public void write(JsonWriter out, DeleteAccepted value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccepted read(JsonReader in) throws IOException {
