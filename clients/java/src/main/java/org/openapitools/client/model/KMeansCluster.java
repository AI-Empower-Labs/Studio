...
import org.openapitools.client.model.Centroid;
...
public class KMeansCluster {
  ...
  public KMeansCluster addCentroidsItem(Centroid centroidsItem) {
    if (this.centroids == null) {
      this.centroids = new ArrayList<>();
    }
    this.centroids.add(centroidsItem);
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KMeansCluster kmeansCluster = (KMeansCluster) o;
    return Objects.equals(this.clusterSize, kmeansCluster.clusterSize) &&
        Objects.equals(this.centroids, kmeansCluster.centroids);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clusterSize, centroids);
  }
  ...
  public String toString() {
    ...
    sb.append("    centroids: ").append(toIndentedString(centroids)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KMeansCluster.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KMeansCluster is not found in the empty JSON string", KMeansCluster.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KMeansCluster.openapiFields.contains(entry.getKey())) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KMeansCluster.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KMeansCluster' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KMeansCluster> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KMeansCluster.class));

       return (TypeAdapter<T>) new TypeAdapter<KMeansCluster>() {
           @Override
           public void write(JsonWriter out, KMeansCluster value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KMeansCluster read(JsonReader in) throws IOException {
