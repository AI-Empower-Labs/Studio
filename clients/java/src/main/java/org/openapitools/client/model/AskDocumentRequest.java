...
public class AskDocumentRequest {
  ...
  public AskDocumentRequest query(String query) {
    this.query = query;
    return this;
  }
  ...
  **/
  ...
  public AskDocumentRequest index(String index) {
    this.index = index;
    return this;
  }
  ...
  **/
  ...
  public AskDocumentRequest filter(List<DocumentFilters> filter) {
    this.filter = filter;
    return this;
  }

  public AskDocumentRequest addFilterItem(DocumentFilters filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AskDocumentRequest minRelevance(Double minRelevance) {
  ...
  **/
  ...
  public AskDocumentRequest llmModel(String llmModel) {
  ...
  **/
  ...
  public AskDocumentRequest embeddingModel(String embeddingModel) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AskDocumentRequest askDocumentRequest = (AskDocumentRequest) o;
    return Objects.equals(this.query, askDocumentRequest.query) &&
        Objects.equals(this.index, askDocumentRequest.index) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AskDocumentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AskDocumentRequest is not found in the empty JSON string", AskDocumentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AskDocumentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AskDocumentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AskDocumentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AskDocumentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AskDocumentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AskDocumentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AskDocumentRequest>() {
           @Override
           public void write(JsonWriter out, AskDocumentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AskDocumentRequest read(JsonReader in) throws IOException {
