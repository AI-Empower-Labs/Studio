...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Centroid : IValidatableObject
    {
        ...
        /// <param name="dataPoints">Array of data points belonging to the centroid.</param>
        public Centroid(Coordinate coordinate = default(Coordinate), List<Coordinate> dataPoints = default(List<Coordinate>))
        {
        ...
        /// </summary>
        /// <value>Array of data points belonging to the centroid</value>
        [DataMember(Name = "dataPoints", EmitDefaultValue = false)]
        public List<Coordinate> DataPoints { get; set; }
