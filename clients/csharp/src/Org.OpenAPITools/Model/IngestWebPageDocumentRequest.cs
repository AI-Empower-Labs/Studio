...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IngestWebPageDocumentRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="url">Web page to ingest</param>
        ...
        [JsonConstructor]
        public IngestWebPageDocumentRequest(string url, string documentId, Option<string?> index = default, Option<string?> webHookUrl = default, Option<string?> embeddingModelName = default, Option<Dictionary<string, string>?> context = default, Option<Dictionary<string, List<string>>?> tags = default, Option<List<string>?> ingestionPipeline = default, Option<bool?> languageAutoDetection = default, Option<LanguageEnum?> language = default)
        {
            Url = url;
    ...
    /// <summary>
    /// A Json converter for type <see cref="IngestWebPageDocumentRequest" />
    /// </summary>
    public class IngestWebPageDocumentRequestJsonConverter : JsonConverter<IngestWebPageDocumentRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="IngestWebPageDocumentRequest" />
        /// </summary>
        ...
        public override IngestWebPageDocumentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<IngestWebPageDocumentRequest.LanguageEnum?> language = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "language":
                            ...
                            if (languageRawValue != null)
                                language = new Option<IngestWebPageDocumentRequest.LanguageEnum?>(IngestWebPageDocumentRequest.LanguageEnumFromStringOrDefault(languageRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!url.IsSet)
                throw new ArgumentException("Property is required for class IngestWebPageDocumentRequest.", nameof(url));

            if (!documentId.IsSet)
                throw new ArgumentException("Property is required for class IngestWebPageDocumentRequest.", nameof(documentId));

            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class IngestWebPageDocumentRequest.");

            if (documentId.IsSet && documentId.Value == null)
                throw new ArgumentNullException(nameof(documentId), "Property is not nullable for class IngestWebPageDocumentRequest.");

            if (languageAutoDetection.IsSet && languageAutoDetection.Value == null)
                throw new ArgumentNullException(nameof(languageAutoDetection), "Property is not nullable for class IngestWebPageDocumentRequest.");

            return new IngestWebPageDocumentRequest(url.Value!, documentId.Value!, index, webHookUrl, embeddingModelName, context, tags, ingestionPipeline, languageAutoDetection, language);
        }

        /// <summary>
        /// Serializes a <see cref="IngestWebPageDocumentRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="ingestWebPageDocumentRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, IngestWebPageDocumentRequest ingestWebPageDocumentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, ingestWebPageDocumentRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="IngestWebPageDocumentRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="ingestWebPageDocumentRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, IngestWebPageDocumentRequest ingestWebPageDocumentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (ingestWebPageDocumentRequest.Url == null)
                throw new ArgumentNullException(nameof(ingestWebPageDocumentRequest.Url), "Property is required for class IngestWebPageDocumentRequest.");

            if (ingestWebPageDocumentRequest.DocumentId == null)
                throw new ArgumentNullException(nameof(ingestWebPageDocumentRequest.DocumentId), "Property is required for class IngestWebPageDocumentRequest.");

            writer.WriteString("url", ingestWebPageDocumentRequest.Url);

            writer.WriteString("documentId", ingestWebPageDocumentRequest.DocumentId);

            if (ingestWebPageDocumentRequest.IndexOption.IsSet)
                if (ingestWebPageDocumentRequest.IndexOption.Value != null)
                    writer.WriteString("index", ingestWebPageDocumentRequest.Index);
                else
                    writer.WriteNull("index");

            if (ingestWebPageDocumentRequest.WebHookUrlOption.IsSet)
                if (ingestWebPageDocumentRequest.WebHookUrlOption.Value != null)
                    writer.WriteString("webHookUrl", ingestWebPageDocumentRequest.WebHookUrl);
                else
                    writer.WriteNull("webHookUrl");

            if (ingestWebPageDocumentRequest.EmbeddingModelNameOption.IsSet)
                if (ingestWebPageDocumentRequest.EmbeddingModelNameOption.Value != null)
                    writer.WriteString("embeddingModelName", ingestWebPageDocumentRequest.EmbeddingModelName);
                else
                    writer.WriteNull("embeddingModelName");

            if (ingestWebPageDocumentRequest.ContextOption.IsSet)
                if (ingestWebPageDocumentRequest.ContextOption.Value != null)
                {
                    writer.WritePropertyName("context");
                    JsonSerializer.Serialize(writer, ingestWebPageDocumentRequest.Context, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("context");
            if (ingestWebPageDocumentRequest.TagsOption.IsSet)
                if (ingestWebPageDocumentRequest.TagsOption.Value != null)
                {
                    writer.WritePropertyName("tags");
                    JsonSerializer.Serialize(writer, ingestWebPageDocumentRequest.Tags, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("tags");
            if (ingestWebPageDocumentRequest.IngestionPipelineOption.IsSet)
                if (ingestWebPageDocumentRequest.IngestionPipelineOption.Value != null)
                {
                    writer.WritePropertyName("ingestionPipeline");
                    JsonSerializer.Serialize(writer, ingestWebPageDocumentRequest.IngestionPipeline, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("ingestionPipeline");
            if (ingestWebPageDocumentRequest.LanguageAutoDetectionOption.IsSet)
                writer.WriteBoolean("languageAutoDetection", ingestWebPageDocumentRequest.LanguageAutoDetectionOption.Value!.Value);

            var languageRawValue = IngestWebPageDocumentRequest.LanguageEnumToJsonValue(ingestWebPageDocumentRequest.LanguageOption.Value!.Value);
            if (languageRawValue != null)
