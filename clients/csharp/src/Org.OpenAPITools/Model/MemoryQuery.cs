...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MemoryQuery : IValidatableObject
    {
        ...
        public MemoryQuery(string index = default(string), string question = default(string), List<Dictionary<string, List<string>>> filters = default(List<Dictionary<string, List<string>>>), double minRelevance = default(double))
        {
            this.Index = index;
