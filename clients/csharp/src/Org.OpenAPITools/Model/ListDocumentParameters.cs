...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListDocumentParameters")]
    public partial class ListDocumentParameters : IValidatableObject
    {
        ...
        public ListDocumentParameters(string index = default(string), List<DocumentFilters> filter = default(List<DocumentFilters>), bool? withEmbeddings = default(bool?), int? limit = default(int?), int? offset = default(int?))
        {
            this.Index = index;
            this.Filter = filter;
        ...
        [DataMember(Name = "withEmbeddings", EmitDefaultValue = true)]
