...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ISemanticSearchApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="wordCloudDocumentRequest"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>byte[]</returns>
        byte[] SemanticSearchWordcloud(WordCloudDocumentRequest wordCloudDocumentRequest, int operationIndex = 0);
        ...
        ApiResponse<byte[]> SemanticSearchWordcloudWithHttpInfo(WordCloudDocumentRequest wordCloudDocumentRequest, int operationIndex = 0);
    ...
    public interface ISemanticSearchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<byte[]> SemanticSearchWordcloudAsync(WordCloudDocumentRequest wordCloudDocumentRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<byte[]>> SemanticSearchWordcloudWithHttpInfoAsync(WordCloudDocumentRequest wordCloudDocumentRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SemanticSearchApi : ISemanticSearchApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>byte[]</returns>
        public byte[] SemanticSearchWordcloud(WordCloudDocumentRequest wordCloudDocumentRequest, int operationIndex = 0)
        {
            Org.OpenAPITools.Client.ApiResponse<byte[]> localVarResponse = SemanticSearchWordcloudWithHttpInfo(wordCloudDocumentRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of byte[]</returns>
        public Org.OpenAPITools.Client.ApiResponse<byte[]> SemanticSearchWordcloudWithHttpInfo(WordCloudDocumentRequest wordCloudDocumentRequest, int operationIndex = 0)
        {
            // verify the required parameter 'wordCloudDocumentRequest' is set
            if (wordCloudDocumentRequest == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'wordCloudDocumentRequest' when calling SemanticSearchApi->SemanticSearchWordcloud");
            }
            ...
            localVarRequestOptions.Data = wordCloudDocumentRequest;

            localVarRequestOptions.Operation = "SemanticSearchApi.SemanticSearchWordcloud";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<byte[]>("/api/semantic/wordcloud", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SemanticSearchWordcloud", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of byte[]</returns>
        public async System.Threading.Tasks.Task<byte[]> SemanticSearchWordcloudAsync(WordCloudDocumentRequest wordCloudDocumentRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Org.OpenAPITools.Client.ApiResponse<byte[]> localVarResponse = await SemanticSearchWordcloudWithHttpInfoAsync(wordCloudDocumentRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (byte[])</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<byte[]>> SemanticSearchWordcloudWithHttpInfoAsync(WordCloudDocumentRequest wordCloudDocumentRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'wordCloudDocumentRequest' is set
            if (wordCloudDocumentRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<byte[]>("/api/semantic/wordcloud", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
