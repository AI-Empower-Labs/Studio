...
class TestApiExtractThematicSimilarityClusterPostRequest(unittest.TestCase):
    """ApiExtractThematicSimilarityClusterPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiExtractThematicSimilarityClusterPostRequest:
        ...
        """
        model = ApiExtractThematicSimilarityClusterPostRequest()
        if include_optional:
    ...
    def testApiExtractThematicSimilarityClusterPostRequest(self):
        """Test ApiExtractThematicSimilarityClusterPostRequest"""
