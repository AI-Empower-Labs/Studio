...
class TestAskDocumentResponse(unittest.TestCase):
    """AskDocumentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AskDocumentResponse:
        """Test AskDocumentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AskDocumentResponse`
        """
        model = AskDocumentResponse()
        if include_optional:
            return AskDocumentResponse(
                ...
                text = '',
                relevant_sources = [
                    openapi_client.models.document_citation.DocumentCitation(
                        link = '', 
                        index = '', 
                        document_id = '', 
                        file_id = '', 
    ...
    def testAskDocumentResponse(self):
        """Test AskDocumentResponse"""
