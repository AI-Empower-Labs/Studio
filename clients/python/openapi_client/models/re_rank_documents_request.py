...
class ReRankDocumentsRequest(BaseModel):
    ...
    """ # noqa: E501
    model: Optional[StrictStr] = Field(default=None, description="Optional embedding model. Defaults to configured default")
    query: Optional[StrictStr] = Field(default=None, description="Semantic query to find matching documents")
    documents: Optional[List[StrictStr]] = Field(default=None, description="Optional index to specify which index to search in. Defaults to 'default'")
    ...
    __properties: ClassVar[List[str]] = ["model", "query", "documents", "limit"]
