...
class SegmentData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["text", "start", "end", "probability", "language"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "start": TimeSpan.from_dict(obj["start"]) if obj.get("start") is not None else None,
            "end": TimeSpan.from_dict(obj["end"]) if obj.get("end") is not None else None,
