...
class SemanticSimilarityResponse(BaseModel):
    ...
    """ # noqa: E501
    documents: Optional[List[SemanticSimilarityDocument]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [SemanticSimilarityDocument.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj
