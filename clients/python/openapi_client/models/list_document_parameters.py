...
class ListDocumentParameters(BaseModel):
    """
    ...
    with_embeddings: Optional[StrictBool] = Field(default=None, description="Optionally specifies if embedding should be returned in response. Default is false", alias="withEmbeddings")
    ...
    offset: Optional[StrictInt] = Field(default=None, description="Optional filter for specifying list offset for paging. Default is 0")
    __properties: ClassVar[List[str]] = ["index", "filter", "withEmbeddings", "limit", "offset"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if with_embeddings (nullable) is None
        # and model_fields_set contains the field
        if self.with_embeddings is None and "with_embeddings" in self.model_fields_set:
            _dict['withEmbeddings'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "withEmbeddings": obj.get("withEmbeddings"),
            "limit": obj.get("limit"),
