...
class ReRankDocumentsResponse(BaseModel):
    ...
    """ # noqa: E501
    documents: Optional[List[ReRankDocument]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [ReRankDocument.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj
