...
class StreamableFileContent(BaseModel):
    """
    ...
    last_write: Optional[datetime] = Field(default=None, alias="lastWrite")
    __properties: ClassVar[List[str]] = ["fileName", "fileSize", "fileType", "lastWrite"]
