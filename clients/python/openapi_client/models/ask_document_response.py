...
class AskDocumentResponse(BaseModel):
    ...
    no_result_reason: Optional[StrictStr] = Field(default=None, description="Content of the answer.", alias="noResultReason")
    text: Optional[StrictStr] = Field(default=None, description="Content of the answer.")
    relevant_sources: Optional[List[DocumentCitation]] = Field(default=None, description="List of the relevant sources used to produce the answer.  Key = Document ID  Value = List of partitions used from the document.", alias="relevantSources")
    __properties: ClassVar[List[str]] = ["noResult", "noResultReason", "text", "relevantSources"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.relevant_sources:
            for _item in self.relevant_sources:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "relevantSources": [DocumentCitation.from_dict(_item) for _item in obj["relevantSources"]] if obj.get("relevantSources") is not None else None
        })
        return _obj
