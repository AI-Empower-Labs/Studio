...
class DetectLanguageResponse(BaseModel):
    ...
    """ # noqa: E501
    languages: Optional[List[LanguageDetection]] = None
    __properties: ClassVar[List[str]] = ["languages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "languages": [LanguageDetection.from_dict(_item) for _item in obj["languages"]] if obj.get("languages") is not None else None
        })
        return _obj
