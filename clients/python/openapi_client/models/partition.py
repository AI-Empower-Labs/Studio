...
class Partition(BaseModel):
    ...
    partition_number: Optional[StrictInt] = Field(default=None, alias="partitionNumber")
    section_number: Optional[StrictInt] = Field(default=None, alias="sectionNumber")
    last_update: Optional[datetime] = Field(default=None, alias="lastUpdate")
    tags: Optional[Dict[str, List[StrictStr]]] = None
    __properties: ClassVar[List[str]] = ["text", "relevance", "partitionNumber", "sectionNumber", "lastUpdate", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partitionNumber": obj.get("partitionNumber"),
