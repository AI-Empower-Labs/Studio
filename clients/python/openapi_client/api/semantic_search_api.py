...
class SemanticSearchApi:
    ...
    @validate_call
    def semantic_search_wordcloud(
        self,
        word_cloud_document_request: WordCloudDocumentRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param word_cloud_document_request: (required)
        :type word_cloud_document_request: WordCloudDocumentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._semantic_search_wordcloud_serialize(
            word_cloud_document_request=word_cloud_document_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def semantic_search_wordcloud_with_http_info(
        self,
        word_cloud_document_request: WordCloudDocumentRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def semantic_search_wordcloud_without_preload_content(
        self,
        word_cloud_document_request: WordCloudDocumentRequest,
        _request_timeout: Union[
            None,
    ...
    def _semantic_search_wordcloud_serialize(
        self,
        word_cloud_document_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if word_cloud_document_request is not None:
            _body_params = word_cloud_document_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/semantic/wordcloud',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
