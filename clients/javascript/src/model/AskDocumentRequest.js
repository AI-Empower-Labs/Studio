...
/**
 * The AskDocumentRequest model module.
 * @module model/AskDocumentRequest
 * @version v1
 */
class AskDocumentRequest {
    /**
     * Constructs a new <code>AskDocumentRequest</code>.
     * @alias module:model/AskDocumentRequest
     */
    constructor() { 
        
        AskDocumentRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AskDocumentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AskDocumentRequest} obj Optional instance to populate.
     * @return {module:model/AskDocumentRequest} The populated <code>AskDocumentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AskDocumentRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AskDocumentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AskDocumentRequest</code>.
     */
...
export default AskDocumentRequest;
