...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.QueryDocumentRequest();
  });
  ...
  describe('QueryDocumentRequest', function() {
    it('should create an instance of QueryDocumentRequest', function() {
      // uncomment below and update the code to test QueryDocumentRequest
      //var instance = new StudioAiEmpowerLabs.QueryDocumentRequest();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.QueryDocumentRequest);
    });
