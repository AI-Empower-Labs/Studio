...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.AskDocumentRequest();
  });
  ...
  describe('AskDocumentRequest', function() {
    it('should create an instance of AskDocumentRequest', function() {
      // uncomment below and update the code to test AskDocumentRequest
      //var instance = new StudioAiEmpowerLabs.AskDocumentRequest();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.AskDocumentRequest);
    });
