...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.IngestTextDocumentRequest();
  });
  ...
  describe('IngestTextDocumentRequest', function() {
    it('should create an instance of IngestTextDocumentRequest', function() {
      // uncomment below and update the code to test IngestTextDocumentRequest
      //var instance = new StudioAiEmpowerLabs.IngestTextDocumentRequest();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.IngestTextDocumentRequest);
    });
