...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.Centroid();
  });
  ...
  describe('Centroid', function() {
    it('should create an instance of Centroid', function() {
      // uncomment below and update the code to test Centroid
      //var instance = new StudioAiEmpowerLabs.Centroid();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.Centroid);
    });
