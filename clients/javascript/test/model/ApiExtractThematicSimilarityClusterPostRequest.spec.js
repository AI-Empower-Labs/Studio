...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.ApiExtractThematicSimilarityClusterPostRequest();
  });
  ...
  describe('ApiExtractThematicSimilarityClusterPostRequest', function() {
    it('should create an instance of ApiExtractThematicSimilarityClusterPostRequest', function() {
      // uncomment below and update the code to test ApiExtractThematicSimilarityClusterPostRequest
      //var instance = new StudioAiEmpowerLabs.ApiExtractThematicSimilarityClusterPostRequest();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.ApiExtractThematicSimilarityClusterPostRequest);
    });
