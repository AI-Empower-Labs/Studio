...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.DocumentPartition();
  });
  ...
  describe('DocumentPartition', function() {
    it('should create an instance of DocumentPartition', function() {
      // uncomment below and update the code to test DocumentPartition
      //var instance = new StudioAiEmpowerLabs.DocumentPartition();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.DocumentPartition);
    });
