...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.ProblemDetails();
  });
  ...
  describe('ProblemDetails', function() {
    it('should create an instance of ProblemDetails', function() {
      ...
      //var instance = new StudioAiEmpowerLabs.ProblemDetails();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.ProblemDetails);
    });
