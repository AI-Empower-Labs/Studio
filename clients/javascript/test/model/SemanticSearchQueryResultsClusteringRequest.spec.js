...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.SemanticSearchQueryResultsClusteringRequest();
  });
  ...
  describe('SemanticSearchQueryResultsClusteringRequest', function() {
    it('should create an instance of SemanticSearchQueryResultsClusteringRequest', function() {
      // uncomment below and update the code to test SemanticSearchQueryResultsClusteringRequest
      //var instance = new StudioAiEmpowerLabs.SemanticSearchQueryResultsClusteringRequest();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.SemanticSearchQueryResultsClusteringRequest);
    });
    ...
    it('should have the property maxDegreeOfParallelism (base name: "maxDegreeOfParallelism")', function() {
      // uncomment below and update the code to test the property maxDegreeOfParallelism
      //var instance = new StudioAiEmpowerLabs.SemanticSearchQueryResultsClusteringRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property maxRelevance (base name: "maxRelevance")', function() {
      // uncomment below and update the code to test the property maxRelevance
      //var instance = new StudioAiEmpowerLabs.SemanticSearchQueryResultsClusteringRequest();
      //expect(instance).to.be();
    });
