...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.IngestWebPageDocumentRequest();
  });
  ...
  describe('IngestWebPageDocumentRequest', function() {
    it('should create an instance of IngestWebPageDocumentRequest', function() {
      // uncomment below and update the code to test IngestWebPageDocumentRequest
