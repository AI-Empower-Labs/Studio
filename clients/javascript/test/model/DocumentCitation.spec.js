...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.DocumentCitation();
  });
  ...
  describe('DocumentCitation', function() {
    it('should create an instance of DocumentCitation', function() {
      // uncomment below and update the code to test DocumentCitation
      //var instance = new StudioAiEmpowerLabs.DocumentCitation();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.DocumentCitation);
    });
    ...
    it('should have the property sourceContentType (base name: "sourceContentType")', function() {
      // uncomment below and update the code to test the property sourceContentType
      //var instance = new StudioAiEmpowerLabs.DocumentCitation();
      //expect(instance).to.be();
    });
