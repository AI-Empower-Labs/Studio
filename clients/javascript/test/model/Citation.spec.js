...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.Citation();
  });
  ...
  describe('Citation', function() {
    it('should create an instance of Citation', function() {
      // uncomment below and update the code to test Citation
      //var instance = new StudioAiEmpowerLabs.Citation();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.Citation);
    });
