...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StudioAiEmpowerLabs.MemoryQuery();
  });
  ...
  describe('MemoryQuery', function() {
    it('should create an instance of MemoryQuery', function() {
      // uncomment below and update the code to test MemoryQuery
      //var instance = new StudioAiEmpowerLabs.MemoryQuery();
      //expect(instance).to.be.a(StudioAiEmpowerLabs.MemoryQuery);
    });
