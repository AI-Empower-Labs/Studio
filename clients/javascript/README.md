...
*StudioAiEmpowerLabs.KernelMemoryApi* | [**kernelMemoryDownload**](docs/KernelMemoryApi.md#kernelMemoryDownload) | **GET** /api/kernelmemory/download | Download specific document
...
*StudioAiEmpowerLabs.MiscellaneousApi* | [**deleteLlmCacheEntry**](docs/MiscellaneousApi.md#deleteLlmCacheEntry) | **DELETE** /api/cache | 
...
*StudioAiEmpowerLabs.SemanticSearchApi* | [**semanticSearchDeleteIndex**](docs/SemanticSearchApi.md#semanticSearchDeleteIndex) | **DELETE** /api/semantic/index/{name} | 
*StudioAiEmpowerLabs.SemanticSearchApi* | [**semanticSearchFileIngestion**](docs/SemanticSearchApi.md#semanticSearchFileIngestion) | **POST** /api/ingest/file | Ingest a File into Semantic Search
*StudioAiEmpowerLabs.SemanticSearchApi* | [**semanticSearchIngestionStatus**](docs/SemanticSearchApi.md#semanticSearchIngestionStatus) | **GET** /api/ingest/status | 
...
*StudioAiEmpowerLabs.SemanticSearchApi* | [**semanticSearchTextIngestion**](docs/SemanticSearchApi.md#semanticSearchTextIngestion) | **POST** /api/ingest/text | Ingest Plain Text for Semantic Search
*StudioAiEmpowerLabs.SemanticSearchApi* | [**semanticSearchWebpageIngestion**](docs/SemanticSearchApi.md#semanticSearchWebpageIngestion) | **POST** /api/ingest/webpage | 
