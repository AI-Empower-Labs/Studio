...
type ApiSemanticSearchWordcloudRequest struct {
	ctx context.Context
	ApiService *SemanticSearchAPIService
	wordCloudDocumentRequest *WordCloudDocumentRequest
}

func (r ApiSemanticSearchWordcloudRequest) WordCloudDocumentRequest(wordCloudDocumentRequest WordCloudDocumentRequest) ApiSemanticSearchWordcloudRequest {
	r.wordCloudDocumentRequest = &wordCloudDocumentRequest
	return r
}

func (r ApiSemanticSearchWordcloudRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.SemanticSearchWordcloudExecute(r)
}

/*
SemanticSearchWordcloud Method for SemanticSearchWordcloud

Generate word cloud from semantic database

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSemanticSearchWordcloudRequest
*/
func (a *SemanticSearchAPIService) SemanticSearchWordcloud(ctx context.Context) ApiSemanticSearchWordcloudRequest {
	return ApiSemanticSearchWordcloudRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *SemanticSearchAPIService) SemanticSearchWordcloudExecute(r ApiSemanticSearchWordcloudRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SemanticSearchAPIService.SemanticSearchWordcloud")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/semantic/wordcloud"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.wordCloudDocumentRequest == nil {
		return localVarReturnValue, nil, reportError("wordCloudDocumentRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.wordCloudDocumentRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
